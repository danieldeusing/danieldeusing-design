...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@danieldeusing/design@0.54.0/dist/danieldeusing-design.min.css" />
    <!-- optional: the real JetBrains Mono webfont (otherwise falls back to Menlo) -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@danieldeusing/design@0.54.0/src/fonts.css" />
  </head>
  <body>
    ...
    <script type="module">
      import { initThemeSwitcher, initDropdowns, initTerminal } from
        "https://cdn.jsdelivr.net/npm/@danieldeusing/design@0.54.0/runtime/index.js";
      initThemeSwitcher();
      initDropdowns();
      initTerminal();
    </script>
